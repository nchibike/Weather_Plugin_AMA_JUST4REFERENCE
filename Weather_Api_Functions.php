                 ...
                 <div class="">
                    ...
                    <div class="card-footer bg-dark text-white" style="line-height: 18px; ">
                       <div class="row">
                         ...
                         <div class="col-md-3" style="font-size: 20px">
                          <?php echo $result['weather'][0]['main']?><br>
                              <small style="font-size: 12px"><?php echo $result['name']?></small>
                         </div>
                         <div class="col-md-3">
                          WIND<br>
                          <?php echo $result['wind']['speed']?> <small>M/H</small> 
                         </div>
                         <div class="col-md-3"><?php echo date('d M',$result['dt'])?> </div>
                       </div>
                    </div>
                  </div>
           </div>
